...
# from stressTestShape import StressTestShape # Uncomment if using StressTestShape
# from spikeTestShape import SpikeTestShape # Uncomment if using SpikeTestShape
...
class AudioTranscriptionUser(HttpUser):
    ...
    def upload_audio_file(self):
        ...
        size_category = random.choices(
            ['small', 'medium', 'large'], 
            weights=[80, 20, 0]
        )[0]  # Assign different probabilities: small (80%), medium (20%), large (0%)
